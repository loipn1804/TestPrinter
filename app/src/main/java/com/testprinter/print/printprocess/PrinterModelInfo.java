...
public class PrinterModelInfo {
    ...
    private static final String[] PS_QL = {"W17H54", "W17H87", "W23H23", "W29H42", "W29H90", "W38H90", "W39H48", "W52H29", "W62H29", "W62H100", "W60H86", "W12", "W29", "W38", "W50", "W54", "W62"};
    ...
    public enum Model {
        ...
        private Model(String[] ports, String[] paperSizes, String[] paperSizesUS) {
            mPorts = ports;
            mPaperSizes = paperSizes;
            mPaperSizesUS = paperSizesUS;
        }

        private Model(String[] ports, String[] paperSizes) {
            this(ports, paperSizes, null);
        }

        private Model(Model alias) {
