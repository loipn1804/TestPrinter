/**
 * Activity of printing pdz files which is already transfered into the printer.
 *
...
import com.testprinter.print.printprocess.TemplatePrint;
...
public class Activity_PrintTemplate extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.btnPrint)).setEnabled(false);
     ...
     */
    public void nextTemplatePrintOnClick(View view) {
    ...
    public void showInputData() {
        ...
        // disable
        if (count > 1) {
            ((Button) findViewById(R.id.btnPrint)).setEnabled(true);
        } else {
            ((Button) findViewById(R.id.btnPrint)).setEnabled(false);
        }
    }
