...
import com.testprinter.print.printprocess.MWBluetoothPrinterPreference;
import com.testprinter.print.printprocess.MWBluetoothPrinterPreference.PrinterPreListener;

public class Activity_MWBluetoothPrinterPreference extends BaseActivity {

    public int SSP_ENABLE_KEY = 1;
    public int SSP_DISABLE_KEY = 2;

    public int PSM_ECO_KEY = 1;
    public int PSM_STANDARD_KEY = 2;
    public int PSM_CONNECTION_KEY = 3;

    public int INDEFINITE = 0;
     ...
     * @param view
     */
    public void getPrinterSettingButtonOnClick(View view) {
        if (!checkUSB())
            return;
        ...
        ((MWBluetoothPrinterPreference) myPrint).getPrinterSetting(lisenter);
     ...
     * @param view
     */
    public void updatePrinterSettingButtonOnClick(View view) {
        if (!checkUSB())
            return;
     ...
     * @return
     */
    public SSP getSspValue(int key) {
     ...
     * @return
     */
    public int getSspKey(SSP value) {
     ...
     * @return
     */
    public PowerSaveMode getPowerSaveModeValue(int key) {
        if (key == PSM_ECO_KEY) {
     ...
     * @return
     */
    public int getPowerSaveModeKey(PowerSaveMode value) {
