...
public class Activity_FileList extends ListActivity {
    ...
    TextView tvFileName = null; // TextView for displaying the file path
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button buttonOk = (Button) findViewById(R.id.btn_fileListOk);
     ...
     */
    public void buttonOkClicked(final View view) {
     ...
     */
    public void buttonCancelClicked(final View view) {
